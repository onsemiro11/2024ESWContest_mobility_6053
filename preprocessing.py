...
def main(dataset_type):
    ...
    rmv_class = ['Pedestrian_Bicycle', 'RoadMark_Character', 'RoadMark_Number',  'Vehicle_Motorcycle', 'Vehicle_Unknown','TrafficSign_Else', 'TrafficSign_Speed','TrafficLight_Yellow','TrafficLight_RedArrow','TrafficLight_Red','TrafficLight_GreenArrow','TrafficLight_Green','TrafficLight_Arrow']
    new_class = ['Pedestrian_Pedestrian', 'RoadMarkArrow_Else', 'RoadMarkArrow_Left', 'RoadMarkArrow_Right', 'RoadMarkArrow_Straight', 'RoadMarkArrow_StraightLeft', 'RoadMarkArrow_StraightRight', 'RoadMarkArrow_Uturn', 'RoadMark_Crosswalk', 'RoadMark_StopLine', 'Vehicle_Bus', 'Vehicle_Car']
